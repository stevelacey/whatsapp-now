  ...
  render() {
    return (
      <div className={`grid grid-flow-row grid-cols-3 grid-rows-3 gap-4 ${this.props.className}`}>
        ...
        {
          this.props.countryCode && this.props.showFlag
            ? <Key onClick={this.props.onFlagClick}>
                <Flag countryCode={this.props.countryCode}/>
              </Key>
            : <Key value="+" onClick={this.props.onFlagClick}/>
        }
        ...
        {this.props.showPaste && (
          <Key
            title="Paste"
            onClick={() => this.props.onPaste()}
          >
            <svg className="fill-white size-6" viewBox="0 0 512 512">
              {
                this.props.isIOS
                  ? <path d="M64 96h384v32H64zM64 240h384v32H64zM64 384h384v32H64z" />
