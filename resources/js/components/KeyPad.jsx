    ...
    return (
      <div className={`grid grid-flow-row grid-cols-3 grid-rows-3 gap-4 ${this.props.className}`}>
        ...
        {this.props.showPaste && (
          <Key
            title="Paste"
            onClick={() => this.props.onPaste && this.props.onPaste()}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-white w-6 h-6">
              {this.props.isIOS && <path d="M64 96h384v32H64zM64 240h384v32H64zM64 384h384v32H64z" />}
